...
## Instructions
1) See the compataible SBC's, and select the one you'll be setting up: [Motherboard Selection](https://github.com/allenc125789/SecurityDrone-Prototype/blob/main/docs/motherboard-list.md)
