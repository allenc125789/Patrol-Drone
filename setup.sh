...
#: Dependancies.
aDEPENDS=("sudo" "libmariadb3" "mariadb-server" "build-essential" "libssl-dev" "libffi-dev" "python3-dev" "libmariadb-dev" "python3.11-venv" "python3-opencv" "python3-numpy" "python3-pil")
    #: Dependancy Check
