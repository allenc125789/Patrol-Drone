...
#: Dependancies.
aDEPENDS=("sudo" "default-mysql-server" "python3.11-venv" "python3-opencv" "python3-numpy" "imagemagick")
    #: Dependancy Check
...
sudo -H -u drone bash -c '/home/drone/.venv/bin/pip3 install -r "SecurityDrone-Prototype/requirements.txt"'
